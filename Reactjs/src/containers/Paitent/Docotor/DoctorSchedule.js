    ...
    for (let i = 0; i < 7; i++){
        ...
        if(language === LANGUAGES.VI) {
          if(i === 0){
            ...
            object.label = this.capotalzeFirstLetter(labelVi)
          }
          ...
          <div className="all-availabel-time">
            <div className="text-calendar">
              <i className="fas fa-calendar-alt">
                <span>
                  <FormattedMessage id="paitent.detail-doctor" />
                </span>
              </i>
            </div>
              ...
              {allAvalableTimes && allAvalableTimes.length > 0 ? 
                <>
                  ...
                  <div className="book-free">
                    <FormattedMessage id="paitent.choose" />
                    <FormattedMessage id="paitent.book-free" />
                    <i className="far fa-hand-point-up"></i>
                  </div>
                </>
                : 
                  <div className="no-schedule">
                    <FormattedMessage id="paitent.no-schedule" />
                  </div>
              }
            </div>
          </div>
