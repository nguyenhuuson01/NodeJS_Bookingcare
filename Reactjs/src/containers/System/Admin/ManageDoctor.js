...
class ManageDoctor extends Component {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if (prevProps.allRequiredDoctorInfor !== this.props.allRequiredDoctorInfor) {
        ...
        let selectedClinic = this.buildDataInputSelect(resClinic, 'CLINIC');
  ...
  render() {
    let { hasOlData, listSpecialty, listClinic} = this.state;
    return (
      <React.Fragment>
        <div className="manage-doctor-container">
          ...
          <div className="more-infor-extra row">
            <div className="colum-tb col-4 form-group">
            ...
            <div className="colum-tb col-4 form-group">
              <label><FormattedMessage id="admin.manage-doctor.provinces" /></label>
              <Select
                value={this.state.selectedProvince}
                onChange={this.handleChangeSelectDoctorInfor}
                options={this.state.listProvince}
                name="selectedProvince"
                placeholder={<FormattedMessage id="admin.manage-doctor.provinces" />}
              />
            </div>
            ...
            <div className="colum-tb col-4 form-group">
              <label><FormattedMessage id="admin.manage-doctor.notes" /></label>
              <input className="form-control" 
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        getAllRequiredDoctorInfor:(data) => dispatch(actions.getAllRequiredDoctorInfor(data)),
    };
};
